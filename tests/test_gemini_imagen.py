...
class TestGeminiImagenClient:
    ...
    @patch('config.gemini_imagen_client.genai.Client')
    @patch('config.gemini_imagen_client.Image')
    ...
    @patch('config.gemini_imagen_client.genai.Client')
    @patch('config.gemini_imagen_client.Image')
    @patch('config.gemini_imagen_client.Path')
...
class TestConvenienceFunctions:
    ...
    @patch('config.gemini_imagen_client.GeminiImagenClient')
